...
const params = {
  Destination: {
    ToAddresses: ['rachel.ajayi@icloud.com'], // This should be your email address
  },
  Message: {
    Body: {
      Text: {
  ...
  Source: 'rachel.ajayi@icloud.com', // This is the email listed in sender. Set it to your email for this practice
};
